...
public class BloomFilter {
    ...
    private BitSet bloomFilter = new BitSet(filterSize);
    ...
    public boolean containsPossibly(String key) {
        return (bloomFilter.get(getBitIndex(HASH_FUNCTION_ONE, key))
                && bloomFilter.get(getBitIndex(HASH_FUNCTION_TWO, key))
        );
    }
